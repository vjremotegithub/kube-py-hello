ubuntu@POCSRV001:~/HellWorld/http_helloworld$ ls -lrt
total 12
...
ubuntu@POCSRV001:~/HellWorld/http_helloworld$


# Build Image
===============
ubuntu@POCSRV001:~/HellWorld/http_helloworld$sudo docker build -t http_helloworld .
...
ubuntu@POCSRV001:~/HellWorld/http_helloworld$ k get deploy
...
ubuntu@POCSRV001:~/HellWorld/http_helloworld$ k get svc
...
kube-apiserver-pocsrv001            1/1     Running            11         15d
kube-controller-manager-pocsrv001   1/1     Running            11         15d
kube-proxy-hcxmh                           1/1     Running            11         15d
kube-proxy-jm4x6                           1/1     Running            11         15d
kube-proxy-wqcwg                           1/1     Running            11         15d
kube-scheduler-pocsrv001            1/1     Running            11         15d
...
ubuntu@POCSRV001:~/HellWorld/http_helloworld$ k get nodes
NAME               STATUS                     ROLES    AGE   VERSION
pocsrv001   Ready,SchedulingDisabled   master   15d   v1.13.2
pocans2srv001   Ready                      <none>   15d   v1.13.2
pocans3srv001   Ready,SchedulingDisabled   <none>   15d   v1.13.2
ubuntu@POCSRV001:~/HellWorld/http_helloworld$


ubuntu@POCSRV001:~/HellWorld/http_helloworld$ wget http://10.200.0.183:30838/
